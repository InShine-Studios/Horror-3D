...
namespace Astralization.Managers.StageSystem
{
    ...
    public class StageBuilder : MonoBehaviour
    {
        ...
        public string SaveStagePoints(string filename)
        {
            ...
            FileSystemHelper.CreateAsset(stagePoints, DirectoryPathSequence, filename + ".asset");
            return filename;
        }
        ...
        public string SaveTransitionZones(string filename)
        {
            ...
            FileSystemHelper.CreateAsset(stageZones, DirectoryPathSequence, filename + ".asset");
            return filename;
        }
