...
namespace Astralization.Managers
{
    ...
    public class HudManager : MonoBehaviour
    {
        ...
        #region SetGet
        private void SetHudState(UiHelper.UiType hudKey, bool condition)
        {
            HideAll();
            switch (hudKey)
            {
                case UiHelper.UiType.Dialogue: ShowDialogue(condition); break;
                case UiHelper.UiType.ExorcismBar: ShowExorcism(condition); break;
                case UiHelper.UiType.HidingOverlay: ShowHidingHud(condition); break;
                case UiHelper.UiType.MindMap: ShowMindMap(condition); break;
                case UiHelper.UiType.Default: ShowDefaultHud(condition); break;
            }
        }
