...
namespace Astralization.Player.PlayerStates
{
    ...
    public class InputManager : StateMachine
    {
        ...
        private void Awake()
        {
            ...
            {
                if (actionMap.name == PlayerHelper.UiInputActionName)
                {
        ...
        #region SetGet
        public void SetPlayerActionMap(PlayerHelper.States playerState)
        {
            SwitchActionMap(playerState);
            switch (playerState) // RACE CONDITION
            {
                case PlayerHelper.States.Default: ChangeState<PlayerDefaultState>(); break;
                case PlayerHelper.States.Hiding: ChangeState<PlayerHidingState>(); break;
                case PlayerHelper.States.Dialogue: ChangeState<PlayerDialogueState>(); break;
                case PlayerHelper.States.Tome: ChangeState<PlayerTomeState>(); break;
                case PlayerHelper.States.Exorcism: ChangeState<PlayerExorcismState>(); break;
                case PlayerHelper.States.MindMap: ChangeState<PlayerCluesMindMapState>(); break;
            }
        ...
        private void SwitchActionMap(PlayerHelper.States playerState)
        {
            _playerInput.SwitchCurrentActionMap(PlayerHelper.PlayerStateActionMapMapper[playerState]);
            if (PlayerHelper.UseUiActionMap.Contains(playerState))
            {
                _uiActionMap.Enable();
            }
            else
